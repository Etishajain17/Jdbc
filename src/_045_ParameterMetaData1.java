...
public class _045_ParameterMetaData1
{
    /*
    ParameterMetaData
     */
    ...
    {
        Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/jdbcpractical?generateSimpleParameterMetadata=true&user=root&password=");
